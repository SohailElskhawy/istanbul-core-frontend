...
export function addRandomRow(): void {
    if (typeof document === 'undefined') return;

    const tableBody = document.getElementById("table-body") as HTMLTableSectionElement | null;
    const emptyState = document.getElementById("empty-state") as HTMLTableRowElement | null;
    const rowCountBadge = document.getElementById("row-count") as HTMLSpanElement | null;
